...
broadband_performance_raw = read_csv(
  "C:\\Users\\Administrator\\Desktop\\Ds_courseWork\\coursework_ds_krishnaChandraShiwakoti\\obtainedData\\Broadband Speed\\201805_fixed_pc_performance_r03.csv"
)
...
write_csv(broadband_postcode_summary,".\\coursework_ds_krishnaChandraShiwakoti\\cleanedData\\broadbandSpeed_performance.csv")