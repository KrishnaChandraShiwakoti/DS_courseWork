...
houseColsNames = c(
 ...
 housePrices2022 = read_csv(
   ".\\coursework_ds_krishnaChandraShiwakoti\\obtainedData\\housePrices-2022.csv",
   col_names = houseColsNames
 )
 housePrices2023 = read_csv(
   ".\\coursework_ds_krishnaChandraShiwakoti\\obtainedData\\housePrices-2023.csv",
   col_names = houseColsNames
 )
 housePrices2024 = read_csv(
   ".\\coursework_ds_krishnaChandraShiwakoti\\obtainedData\\housePrices-2024.csv",
   col_names = houseColsNames
 )
